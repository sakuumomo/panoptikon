...
3. Create the Python inference environment:
   ...
   an NVIDIA driver is present, **ROCm** on Linux with a ROCm 7.2.x install
   (locked to pytorch.org multi-arch `rocm7.2` wheels, including RDNA2
   gfx1030), otherwise **CPU**; macOS always gets the standard PyPI wheels
